...
extern const VlUnpacked<CData/*0:0*/, 8192> Vtb_computer__ConstPool__TABLE_hdd1223d3_0;
...
VL_INLINE_OPT void Vtb_computer___024root___nba_sequent__TOP__1(Vtb_computer___024root* vlSelf) {
    ...
    __Vtableidx2 = 0;
    CData/*3:0*/ __Vdly__tb_computer__DOT__state;
    __Vdly__tb_computer__DOT__state = 0;
    // Body
    __Vdly__tb_computer__DOT__state = vlSelfRef.tb_computer__DOT__state;
    vlSelfRef.__Vdly__tb_computer__DOT__dut__DOT__address_inst 
    ...
    if (Vtb_computer__ConstPool__TABLE_hdd1223d3_0[__Vtableidx2]) {
        __Vdly__tb_computer__DOT__state = Vtb_computer__ConstPool__TABLE_hae9da8c5_0
            [__Vtableidx2];
    }
    if (vlSelfRef.tb_computer__DOT__reset) {
        if ((((7U == (IData)(vlSelfRef.tb_computer__DOT__state)) 
        ...
        vlSelfRef.__Vdly__tb_computer__DOT__dut__DOT__address_inst = 0U;
        vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__SP_address = 0U;
    }
    vlSelfRef.tb_computer__DOT__state = __Vdly__tb_computer__DOT__state;
}
...
#endif
            VL_FATAL_MT("CPUdesign.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("CPUdesign.v", 1, "", "Active region did not converge.");
            }
