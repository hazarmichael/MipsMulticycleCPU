...
VL_ATTR_COLD void Vtb_computer___024root___eval_static__TOP(Vtb_computer___024root* vlSelf);
...
VL_ATTR_COLD void Vtb_computer___024root___eval_static(Vtb_computer___024root* vlSelf) {
    ...
    // Body
    Vtb_computer___024root___eval_static__TOP(vlSelf);
    Vtb_computer___024root____Vm_traceActivitySetAll(vlSelf);
}

VL_ATTR_COLD void Vtb_computer___024root___eval_static__TOP(Vtb_computer___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_computer___024root___eval_static__TOP\n"); );
    Vtb_computer__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[0U] = 0U;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[1U] = 0x1066U;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[2U] = 0x15dcU;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[3U] = 0x385aU;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[4U] = 0x1dbcU;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[5U] = 0x19eeU;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[6U] = 0x2738U;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[7U] = 0xf5aU;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[8U] = 0x1036U;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[9U] = 0x1906U;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[0xaU] = 0x1518U;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[0xbU] = 0x217cU;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[0xcU] = 0x3fc4U;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[0xdU] = 0x2288U;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[0xeU] = 0x2042U;
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__file__DOT__regArray[0xfU] = 0x2bdcU;
}
...
VL_ATTR_COLD void Vtb_computer___024root___eval_initial__TOP(Vtb_computer___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_READMEM_N(true, 32, 28673, 0, std::string{"mul.dat"}
...
#endif
            VL_FATAL_MT("CPUdesign.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_computer___024root___stl_sequent__TOP__0(Vtb_computer___024root* vlSelf) {
    ...
    __Vtableidx3 = (((3U != (vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__instruction 
                             >> 0x1aU)) << 6U) | (((IData)(vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__control__DOT__jmp) 
                                                  ...
                                                  | (((IData)(vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__control__DOT__PUSH_Branch) 
                                                      << 4U) 
                                                     | (IData)(vlSelfRef.tb_computer__DOT__state))));
    ...
    vlSelfRef.tb_computer__DOT__ALUop = Vtb_computer__ConstPool__TABLE_h29c95cbc_0
        [__Vtableidx4];
    ...
    if ((2U & (IData)(vlSelfRef.tb_computer__DOT__ALUop))) {
        vlSelfRef.tb_computer__DOT__ALUresult = ((1U 
                                                  & (IData)(vlSelfRef.tb_computer__DOT__ALUop))
                                                  ? 
                                                 (vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__ALU_operand2 
                                                  - vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__ALU_operand1)
                                                  : 
                                                 (vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__ALU_operand1 
                                                  - vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__ALU_operand2));
    } else if ((1U & (IData)(vlSelfRef.tb_computer__DOT__ALUop))) {
        vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__alu__DOT__carry 
            = ((2U & (IData)(vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__alu__DOT__carry)) 
               | (((0x7fffffffU & vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__ALU_operand1) 
                  ...
                  >> 0x1fU));
        vlSelfRef.tb_computer__DOT__ALUresult = ((0x80000000U 
        ...
        vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__alu__DOT__carry 
            = ((1U & (IData)(vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__alu__DOT__carry)) 
               | ((IData)(vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__alu__DOT____Vconcswap_1_h5d975f9c__0) 
                  << 1U));
        vlSelfRef.tb_computer__DOT__ALUresult = ((0x7fffffffU 
                                                  & vlSelfRef.tb_computer__DOT__ALUresult) 
                                                 | ((IData)(vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__alu__DOT____Vconcswap_1_h5d95ae6b__0) 
                                                    << 0x1fU));
    } else {
        vlSelfRef.tb_computer__DOT__ALUresult = (vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__ALU_operand1 
                                                 & vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__ALU_operand2);
    }
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__pc_control__DOT____VdfgRegularize_h1d606512_0_1 
        = (1U & ((vlSelfRef.tb_computer__DOT__ALUresult 
    ...
    vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__stack_select_wire 
        = ((IData)(vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__StackSelect)
            ? (vlSelfRef.tb_computer__DOT__dut__DOT__cpu__DOT__d1__DOT__SP_address 
               - (IData)(1U)) : vlSelfRef.tb_computer__DOT__ALUresult);
}
...
VL_ATTR_COLD void Vtb_computer___024root___ctor_var_reset(Vtb_computer___024root* vlSelf) {
    ...
    vlSelf->tb_computer__DOT__data_in = VL_RAND_RESET_I(32);
    vlSelf->tb_computer__DOT__data_out = VL_RAND_RESET_I(32);
    vlSelf->tb_computer__DOT__address_data = VL_RAND_RESET_I(32);
    vlSelf->tb_computer__DOT__address_inst = VL_RAND_RESET_I(32);
    vlSelf->tb_computer__DOT__state = VL_RAND_RESET_I(4);
    vlSelf->tb_computer__DOT__out = VL_RAND_RESET_I(32);
    vlSelf->tb_computer__DOT__rr = VL_RAND_RESET_I(32);
    vlSelf->tb_computer__DOT__ALUop = VL_RAND_RESET_I(2);
    vlSelf->tb_computer__DOT__ALUresult = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vdly__tb_computer__DOT__dut__DOT__address_inst = VL_RAND_RESET_I(32);
